...
/obj/item/matter_decompiler/afterattack(atom/target, mob/living/user, proximity, params)
	...
	if(grabbed_something)
		to_chat(user, "<span class='notice'>You deploy your decompiler and clear out the contents of [T].</span>")
	else
		to_chat(user, "<span class='warning'>Nothing on [T] is useful to you.</span>")
	return
